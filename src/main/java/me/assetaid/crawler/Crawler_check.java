...
@Component
public class Crawler_check {
    private WebDriver driver;
    private final CardRepository cardRepository;
    private final WebDriverUtil webDriverUtil;
    private final Logger logger = Logger.getLogger(Crawler_check.class.getName());

    private String baseUrl = "https://card-gorilla.com/card?cate=CHK";
    ...
    @Autowired
    public Crawler_check(WebDriverUtil webDriverUtil, CardRepository cardRepository) {
