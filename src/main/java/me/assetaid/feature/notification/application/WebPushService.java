...
public class WebPushService {
    ...
    // 웹 푸시 알림 발송 메서드
    public void sendPushNotification(String userId, String title, String message, Long goalId) {
    ...
    private String buildPushPayload(String userId, String title, String message, Long goalId) {
